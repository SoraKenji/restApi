    ...
    it('Should get photos of album', async () => {
        try {
            ...
            for (const element of photosAlbum) {
                expect(element).to.contain.keys('id', 'albumid', 'title', 'url', 'thumbnailurl');
            }
            return Promise.resolve();
        } catch (err) {
            return Promise.reject(err);
    ...
    it('Should get addresses', async () => {
        try {
            ...
            for (const element of addresses) {
                ...
                expect(element).to.contain.keys('id', 'userid', 'street', 'suite', 'city', 'zipcode', 'lat', 'lng');
            }
            return Promise.resolve();
        } catch (err) {
            return Promise.reject(err);
    ...
    it('Should get companies', async () => {
        try {
            ...
            for (const element of companies) {
                ...
                expect(element).to.contain.keys('id', 'userid', 'name', 'catchphrase', 'bs');
            }
            return Promise.resolve();
        } catch (err) {
            return Promise.reject(err);
